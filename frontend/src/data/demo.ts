...
export const throughput24h: ThroughputPoint[] = Array.from({ length: 24 }).map((_, index) => {
...
export const alerts7d: AlertsPoint[] = ["Mon", "Tue", "Wed", "Thu", "Fri", "Sat", "Sun"].map((day, idx) => {
...
export const consumptionSplit: ConsumptionSlice[] = [
  { label: "AHU", value: 32 },
...
export const fleetHealth: FleetHealthSummary = {
  healthy: 228,
  warning: 18,
  critical: 5
};
